...
import type { Hotel as PayloadHotel } from '@/payload-types'

interface HotelsPageClientProps {
  initialHotels: PayloadHotel[]
}

export default function HotelsPageClient({ initialHotels }: HotelsPageClientProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="-mt-32 relative z-20">
        <HotelListing initialHotels={initialHotels} />
      </div>
